...
class houses(scrapy.Spider):
    ...
    def parse(self, response):  
        try:
            ...
            url = ""
        try:
            address = str(response.xpath("//*[@id='hdp-content']/div/div/header/h1/text()").extract()[0]).strip(', ')
        except:
            address = ""
        try:
        ...
        try:
            ...
            lot = str(features[5])
        try:
            badrooms =str(response.xpath("//*[@id='hdp-content']/div/div/header/h3/span/text()").extract()[1])
        except:
            badrooms =""
        try:
            bathrooms = str(response.xpath("//*[@id='hdp-content']/div/div/header/h3/span/text()").extract()[3])
        except:
            bathrooms =""
        try:
            size = str(response.xpath("//*[@id='hdp-content']/div/div/header/h3/span/text()").extract()[5])
        except:
            size = ""
        try:
            sellPrice =  str(response.xpath("//*[@id='home-value-wrapper']/div/div[2]/span/text()").extract()[0])
        except:
            sellPrice = ""
        try:
        ...
        if description == "":
            try:
                ...
                description = ""
        try:
            daysOnZillow = str(features[6])
        except:
            daysOnZillow = ""
        try:
            pricePerSqft = str(features[7])
        except:
            pricePerSqft = ""
